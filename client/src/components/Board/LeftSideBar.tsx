...
export default function LeftSideBar({
    ...
    return (
        <div className="bg-white/90 backdrop-blur-md border border-slate-200/80 rounded-3xl p-4 shadow-sm flex flex-col justify-between h-full min-h-[460px]">
            ...
            {/* Role indicator */}
            <div className="mt-4 w-full py-2.5 px-4 bg-slate-900 text-white rounded-2xl font-semibold text-xs flex items-center justify-between">
                <span className="text-slate-400">Current Role</span>
                <span className="bg-slate-800 text-amber-300 px-2.5 py-1 rounded-xl text-[11px] font-bold border border-slate-700/60">
